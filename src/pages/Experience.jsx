      ...
      <div className="container mx-auto max-w-6xl px-6 md:px-8 lg:px-12 relative z-10">
        ...
        <div className="mt-16">
          <a 
            ...
            className="inline-flex items-center gap-2 text-slate-900 dark:text-white font-semibold text-lg hover:text-brand-primary dark:hover:text-brand-secondary transition-colors group"
          >
