  ...
  return (
    <section className="section-padding relative bg-brand-bg-light dark:bg-brand-bg-dark overflow-hidden transition-colors duration-300">
      <div className="content-container relative z-10">
        ...
        >
          {jobs.map((job, index) => (
            <motion.div variants={fadeUp} key={index} className="group relative grid grid-cols-1 md:grid-cols-8 gap-4 md:gap-8 transition-all sm:hover:bg-black/[0.02] dark:sm:hover:bg-white/[0.02] sm:p-6 sm:-m-6 rounded-2xl">
              {/* Left Column: Date */}
        ...
        >
          <a 
            ...
            className="inline-flex items-center gap-2 text-slate-900 dark:text-white font-semibold text-lg hover:text-slate-600 dark:hover:text-zinc-300 transition-colors group"
          >
