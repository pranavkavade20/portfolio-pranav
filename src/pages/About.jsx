...
function About() {
  return (
    <main className="min-h-screen relative overflow-hidden flex flex-col items-center pt-24 pb-20 md:pt-32 md:pb-32">
      ...
      <div className="absolute top-[-10%] left-[-10%] w-[500px] h-[500px] bg-blue-100/50 rounded-full blur-[100px] z-0 animate-pulse"></div>
      <div className="absolute bottom-[10%] right-[-10%] w-[600px] h-[600px] bg-indigo-50/50 rounded-full blur-[120px] z-0 animate-pulse" style={{ animationDelay: '2s' }}></div>
      ...
      <div className="container mx-auto max-w-7xl px-6 relative z-10 flex flex-col w-full">
        ...
        >
          ...
          <h1 className="text-4xl md:text-6xl font-extrabold tracking-tight text-slate-900 mb-6">
            Building the Web, <br className="hidden md:block"/> <span className="text-blue-600">One Stack at a Time.</span>
          </h1>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-20 items-center mb-24 md:mb-32">
          ...
          >
            <div className="relative w-full max-w-[320px] aspect-[4/5] rounded-3xl overflow-hidden shadow-2xl shadow-blue-900/10 border border-slate-100/50">
            ...
            <motion.div 
              ...
              className="absolute -top-6 -right-6 bg-white px-5 py-3 rounded-2xl shadow-xl shadow-slate-200/50 border border-slate-100"
            >
          ...
          >
            <Card className="p-8 md:p-10">
              <h3 className="text-slate-900 font-bold text-lg mb-4 flex items-center gap-3">
                <Code2 className="text-blue-500" size={24} />
                The Identity
              </h3>
              <p className="text-slate-600 text-base md:text-lg leading-relaxed">
                I am a high-energy, detail-oriented <strong className="text-slate-900">Full Stack Python Developer</strong>. As a fresher, I don't just write code; I obsess over architecture, scalability, and user experience. I thrive in the space where robust backend logic meets seamless frontend design.
              </p>
            </Card>
        ...
        <div className="flex flex-wrap justify-center gap-6 md:gap-12 mb-24 md:mb-32">
          {[
            ...
            <motion.div 
              ...
              className="w-16 h-16 md:w-24 md:h-24 bg-white rounded-2xl md:rounded-3xl border border-slate-100 shadow-sm flex items-center justify-center p-3 md:p-5"
            >
        ...
        >
          <div className="absolute -top-12 right-4 md:-top-16 md:-right-8 w-24 h-24 md:w-32 md:h-32 bg-blue-50 rounded-full border-4 border-white shadow-xl overflow-hidden z-20">
          ...
          <Card className="p-10 md:p-16 text-center space-y-10 relative overflow-hidden">
            ...
            <p className="text-xl md:text-3xl text-slate-700 font-medium leading-relaxed max-w-2xl mx-auto">
              Creating secure, scalable <strong className="text-blue-600">Python</strong> & <strong className="text-indigo-600">React</strong> Web Applications. Let's build something great.
            </p>
